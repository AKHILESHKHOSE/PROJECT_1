...
*/
--1
--CREATING 'matches' TABLE IN A NON-PUBLIC SCHEMA 'myschema'  WITH REQUIRED FIELDS MENTIONED IN PROJECT_STATEMENT.txt
...
--CREATING 'deliveries' TABLE IN A NON-PUBLIC SCHEMA 'myschema'  WITH REQUIRED FIELDS MENTIONED IN PROJECT_STATEMENT.txt
-- VERIFICATION
